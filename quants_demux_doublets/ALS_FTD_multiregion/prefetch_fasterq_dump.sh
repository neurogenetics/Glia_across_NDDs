...
SRR=${1}
PREFETCH_OUTDIR=/data/ADRD/ALSFTD_multiregion/fastq_processing/all_fastqs/sra
DOWNLOAD_OUTDIR=/data/ADRD/ALSFTD_multiregion/fastq_processing/all_fastqs/fastq/$SRR
