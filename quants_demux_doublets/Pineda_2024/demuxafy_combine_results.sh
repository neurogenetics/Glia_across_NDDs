...
OUTDIR=/data/ADRD/ALSFTD_multiregion/fastq_processing/demuxafy/outs/$FASTQ/combined
...
singularity exec --bind /data/ADRD/ALSFTD_multiregion/fastq_processing Demuxafy.sif Combine_Results.R \
