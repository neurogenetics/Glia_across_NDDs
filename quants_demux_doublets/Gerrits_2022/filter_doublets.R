...
demuxafy_combined_results_dir <- paste0("/data/ADRD/gerrits_ftd_snRNA/fastq_processing/demuxafy/outs/", fastq, "/combined/combined_results.tsv")
...
cellbender_barcodes_dir <- paste0("/data/ADRD/gerrits_ftd_snRNA/fastq_processing/cellbender/outs/", fastq, "/cellbender_cell_barcodes.csv")
...
cellranger_mat_dir <- paste0("/data/ADRD/gerrits_ftd_snRNA/fastq_processing/cellranger/outs/", fastq, "/raw_feature_bc_matrix/")
...
cellbender_mat_dir <- paste0("/data/ADRD/gerrits_ftd_snRNA/fastq_processing/cellbender/outs/", fastq, "/cellbender_filtered.h5")
...
cellranger_seurat_dir <- paste0("/data/ADRD/gerrits_ftd_snRNA/fastq_processing/final_outs/", fastq, "/", fastq, "_cellranger_seurat.rds")
cellbender_seurat_dir <- paste0("/data/ADRD/gerrits_ftd_snRNA/fastq_processing/final_outs/", fastq, "/", fastq, "_cellbender_seurat.rds")
