...
OUTDIR=/data/ADRD/AD_multiregion/fastq_processing/demuxafy/outs/$FASTQ/combined
...
SCDS_OUTDIR=/data/ADRD/AD_multiregion/fastq_processing/demuxafy/outs/$FASTQ/scds

module load singularity

export SINGULARITY_CACHEDIR=/data/ADRD/AD_multiregion/fastq_processing/demuxafy/.singularity

singularity exec --bind /data/ADRD/AD_multiregion/fastq_processing Demuxafy.sif Combine_Results.R \
