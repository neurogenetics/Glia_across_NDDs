...
OUTDIR=/data/ADRD/glia_across_NDDs/iMG_meta_analysis/Drager2022/fastq_processing/cellranger/outs/$FASTQ
FASTQ_DIR=/data/ADRD/glia_across_NDDs/iMG_meta_analysis/Drager2022/fastq_processing/all_fastqs/fastq/$FASTQ
