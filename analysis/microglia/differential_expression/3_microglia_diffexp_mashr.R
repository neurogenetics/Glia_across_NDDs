...
res_list <- readRDS("./analysis/microglia/differential_expression/microglia_diffexp_results_for_mashr.rds")
...
saveRDS(m.ed, file = "./analysis/microglia/differential_expression/microglia_diffexp_mashr_object.rds")
saveRDS(strong_subset_genes, file = "./analysis/microglia/differential_expression/microglia_strong_subset_genes.rds")
