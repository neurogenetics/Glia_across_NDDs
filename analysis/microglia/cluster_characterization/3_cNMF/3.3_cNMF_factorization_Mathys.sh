...
DIR=/data/ADRD/glia_across_NDDs/analysis/microglia/cluster_characterization/cNMF_by_dataset/Mathys
...
~/.local/bin/cnmf consensus --output-dir $DIR --name microglia --components 12 --local-density-threshold 0.12 --show-clustering
