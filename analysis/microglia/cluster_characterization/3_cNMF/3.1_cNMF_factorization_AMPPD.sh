...
DIR=/data/ADRD/glia_across_NDDs/analysis/microglia/cluster_characterization/cNMF_by_dataset/AMPPD
...
~/.local/bin/cnmf consensus --output-dir $DIR --name microglia --components 17 --local-density-threshold 2 --show-clustering

# then run again after checking density threshold plot
~/.local/bin/cnmf consensus --output-dir $DIR --name microglia --components 13 --local-density-threshold 0.12 --show-clustering
