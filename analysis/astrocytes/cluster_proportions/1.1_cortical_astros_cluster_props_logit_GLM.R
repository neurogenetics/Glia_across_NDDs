...
astro_celllevel_meta <- readRDS("./analysis/astrocytes/cortical_astros_metadata_ANNOTATED.rds")
...
saveRDS(props, "./analysis/astrocytes/cluster_proportions/cortical_astro_raw_donor_region_props.rds")
...
astro_props <- readRDS("./analysis/astrocytes/cluster_proportions/cortical_astro_raw_donor_region_props.rds")
donor_meta <- readRDS("./metadata/cleaned/meta_merged.rds")
...
saveRDS(astro_glm_summary_combined, file = "./analysis/astrocytes/cluster_proportions/cortical_astro_props_logit_GLM_results_1v1.rds")
