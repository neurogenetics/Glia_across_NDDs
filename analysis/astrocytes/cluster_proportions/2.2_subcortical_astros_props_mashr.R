...
astro_props_glm_res <- readRDS("./analysis/astrocytes/cluster_proportions/subcortical_astro_props_logit_GLM_results_1v1.rds")
...
saveRDS(m.c, "./analysis/astrocytes/cluster_proportions/subcortical_astros_props_mashr_obj_canonical.rds")
