...
celllevel_meta_cortical <- readRDS("./analysis/astrocytes/cortical_astros_metadata_ANNOTATED.rds")
celllevel_meta_cortical <- celllevel_meta_cortical[c("nCount_RNA", "nFeature_RNA", "donor", "region", "pct.mito", "dataset", 
                                                     "dataset_region", "cluster_anno")]

celllevel_meta_subcortical <- readRDS("./analysis/astrocytes/subcortical_astros_metadata_ANNOTATED.rds")
celllevel_meta_subcortical <- celllevel_meta_subcortical[c("nCount_RNA", "nFeature_RNA", "donor", "region", "pct.mito", "dataset", 
                                                           "dataset_region", "cluster_anno")]

celllevel_meta <- rbind(celllevel_meta_cortical, celllevel_meta_subcortical)
...
if (dataset == "Pineda") {
  cts <- readRDS("./analysis/astrocytes/differential_expression/single_cell_cts_matrices/Pineda_astrocytes_sc_cts.rds")
} else if (dataset == "AMP-PD") {
  cts <- readRDS("./analysis/astrocytes/differential_expression/single_cell_cts_matrices/AMP-PD_astrocytes_sc_cts.rds")
} else if (dataset == "Mathys") {
  cts <- readRDS("./analysis/astrocytes/differential_expression/single_cell_cts_matrices/Mathys_astrocytes_sc_cts.rds")
} else {
  cts <- readRDS("./analysis/astrocytes/differential_expression/single_cell_cts_matrices/Gerrits_astrocytes_sc_cts.rds")
}
...
saveRDS(covar_selection_list, file = paste0("./analysis/astrocytes/differential_expression/covar_selection/", dataset, "_", brain_region, "_", disease, "_covar_selection.rds"))
...
saveRDS(DESeq_results, file = paste0("./analysis/astrocytes/differential_expression/DESeq_results/", dataset, "_", brain_region, "_", disease, "_DESeq_results.rds"))
...
saveRDS(nebula_results, file = paste0("./analysis/astrocytes/differential_expression/nebula_results/", dataset, "_", brain_region, "_", disease, "_nebula_results.rds"))
