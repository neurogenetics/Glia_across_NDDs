...
# test <- "Mathys_HIP_AD"  # dataset_region_disease
...
celllevel_meta <- readRDS("./analysis/oligodendrocytes/oligos_celllevel_metadata_ANNOTATED.rds")
celllevel_meta$region <- ifelse(celllevel_meta$region == "HC", "HIP", celllevel_meta$region)
...
if (dataset == "Pineda") {
  cts <- readRDS("./analysis/oligodendrocytes/differential_expression/single_cell_cts_matrices/ALS_oligos_merged_cts.rds")
} else if (dataset == "Mathys") {
  cts <- readRDS("./analysis/oligodendrocytes/differential_expression/single_cell_cts_matrices/AD_oligos_merged_cts.rds")
} else if (dataset == "AMP-PD" & brain_region == "DMV") {
  cts <- readRDS("./analysis/oligodendrocytes/differential_expression/single_cell_cts_matrices/AMP-PD_DMV_oligos_cts.rds")
} else if (dataset == "AMP-PD" & brain_region == "GPi") {
  cts <- readRDS("./analysis/oligodendrocytes/differential_expression/single_cell_cts_matrices/AMP-PD_GPi_oligos_cts.rds")
} else if (dataset == "AMP-PD" & brain_region == "M1") {
  cts <- readRDS("./analysis/oligodendrocytes/differential_expression/single_cell_cts_matrices/AMP-PD_M1_oligos_cts.rds")
} else if (dataset == "AMP-PD" & brain_region == "PFC") {
  cts <- readRDS("./analysis/oligodendrocytes/differential_expression/single_cell_cts_matrices/AMP-PD_PFC_oligos_cts.rds")
} else {
  cts <- readRDS("./analysis/oligodendrocytes/differential_expression/single_cell_cts_matrices/AMP-PD_V1_oligos_cts.rds")
}
...
rownames(celllevel_meta) <- sub("^_+", "", rownames(celllevel_meta))
colnames(cts) <- sub("^_+", "", colnames(cts))
...
saveRDS(covar_selection_list, file = paste0("./analysis/oligodendrocytes/differential_expression/covar_selection/", dataset, "_", brain_region, "_", disease, "_covar_selection.rds"))
...
saveRDS(DESeq_results, file = paste0("./analysis/oligodendrocytes/differential_expression/DESeq_results/", dataset, "_", brain_region, "_", disease, "_DESeq_results.rds"))
...
saveRDS(nebula_results, file = paste0("./analysis/oligodendrocytes/differential_expression/nebula_results/", dataset, "_", brain_region, "_", disease, "_nebula_results.rds"))
