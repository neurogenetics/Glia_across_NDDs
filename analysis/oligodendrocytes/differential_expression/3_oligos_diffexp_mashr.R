...
pval_df <- pval_df[, -1] %>% 
  as.matrix()
pval_df[pval_df == 0] <- .Machine$double.xmin
...
saveRDS(m.ed, file = "./analysis/oligodendrocytes/differential_expression/oligodendrocytes_diffexp_mashr_object.rds")
saveRDS(strong_subset_genes, file = "./analysis/oligodendrocytes/differential_expression/oligodendrocytes_strong_subset_genes.rds")
