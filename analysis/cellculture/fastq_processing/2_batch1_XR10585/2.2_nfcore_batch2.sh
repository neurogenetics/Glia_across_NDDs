...
--input ./code_organized/cellculture/iMG_bulk_RNA/fastq_processing/2_batch1_XR10585/samplesheet_2.csv \
...
mv ./analysis/cellculture/iMG_bulk_RNA/tmp_outs/* ./analysis/cellculture/iMG_bulk_RNA/nfcore_outs/batch1_XR10585/processing_batch2/
