...
--input ./code_organized/cellculture/iMG_bulk_RNA/fastq_processing/3_batch2_DA10634/samplesheet_1.csv \
...
mv ./analysis/cellculture/iMG_bulk_RNA/tmp_outs/* ./analysis/cellculture/iMG_bulk_RNA/nfcore_outs/batch2_DA10634/processing_batch1/
